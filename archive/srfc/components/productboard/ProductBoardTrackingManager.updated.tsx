...
import { extractAndSyncRankings } from '../../lib/productBoardRankingExtractor';
...
export function ProductBoardTrackingManager() {
  ...
  const handleSyncBoard = async (board: ProductBoardTrackedBoard) => {
    ...
    try {
      ...
      toast.success(`Synced ${result.newItems + result.updatedItems} items from "${board.board_name}"`);
